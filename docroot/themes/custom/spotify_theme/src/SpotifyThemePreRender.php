...
namespace Drupal\spotify_theme;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the SpotifyTheme theme.
 *
 * @internal
 */
class SpotifyThemePreRender implements TrustedCallbackInterface {
